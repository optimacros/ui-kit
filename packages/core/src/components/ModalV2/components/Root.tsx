...
export const backdropClassName = tw`fixed z-[var(--z-dialog-backdrop)] inset-0 bg-[var(--Modal-overlay-bg)]`;
export const positionerClassName = tw`fixed z-[var(--z-dialog-backdrop)] inset-0 flex items-center justify-center h-screen w-screen`;
export const contentClassName = tw`flex flex-col items-start rounded-[var(--border-radius)] bg-[var(--Modal-bg)]
border-1 border-solid border-[var(--color-divider)] max-w-[80vw] max-h-[80vh]`;
